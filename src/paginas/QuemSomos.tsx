  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white pt-24 sm:pt-24 md:pt-8">
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <h1 className="text-4xl font-bold mb-8 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Quem Somos</h1>
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold mb-4 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Nossa Missão</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold mb-4 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Nossa Visão</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold mb-4 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Nossos Valores</h2>
        ...
        <div>
          <section className="mb-8">
            <h2 className="text-3xl font-semibold mb-4 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Nossos Produtos</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold mb-4 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Por que Escolher a M3 Caminhões?</h2>
            <ul className="list-disc list-inside ml-4">
      ...
      <section className="mt-8 max-w-4xl mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-4 border-l-4 md:border-l-0 md:border-b-4 border-red-600">Contato</h2>
        <p>
